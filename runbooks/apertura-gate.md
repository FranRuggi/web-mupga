...
`site/status.php`, `site/hora.php`, `site/downloads.php`, `site/server-info.php`,
`online.php`, `serverinfo.php` y todo `/api/admin/*`. Los dos últimos son los widgets del sidebar (conectados, rates y total
