...
- [x] **Seguridad:** cutoff de predicciones movido a SQL Server (`DATEADD(MINUTE, 60, GETDATE()) < match_datetime_utc`); auto-lock al inicio del partido; transacción con UPDLOCK/HOLDLOCK; `submitted_at` explícito en INSERT — 2026-06-19
...
- 2026-06-19 — [Seguridad] Prode: cutoff server-side con GETDATE(), auto-lock al inicio, UPDLOCK/HOLDLOCK, submitted_at explícito en INSERT — ver CLAUDE.md § Incidentes de Seguridad
