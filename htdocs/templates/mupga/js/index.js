document.addEventListener('DOMContentLoaded', function() {
    ...
    // Accordion functionality for submenu toggles
    var siteMenuBtn = document.querySelector('.site_menu');
    var siteMenuMobileBtn = document.querySelector('.site_menu-mobile');
    var accountMenuBtn = document.querySelector('.account_menu');
    var accountMenuMobileBtn = document.querySelector('.account_menu-mobile');
    ...
    if(siteMenuMobileBtn) {
        siteMenuMobileBtn.addEventListener('click', function () {
    ...
    if(accountMenuMobileBtn) {
        accountMenuMobileBtn.addEventListener('click', function () {
