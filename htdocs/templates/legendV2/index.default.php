        ...
        <nav class="main-nav">
            <div class="site-nav">
                ...
                <ul class="site-nav__list">
                    <li class="site-nav__item">
                        <div class="modal__field-label selectdiv"><span class="copyright22">Server: <b>MuPGA</b></span></div>                    </li>
            ...
            <div class="site-nav__mobile">
                ...
                <div class="site-menu__social site-menu__social--molile">
                    ...
                    <a class="site-menu__social-link site-menu__social-link--facebook" href="<?php config('social_link_facebook'); ?>" target="_blank">
                        <span><i class="fab fa-facebook"></i> <b>Facebook</b></span>
                    </a>
                </div>
                            </div>
            <div class="user-nav">
...
<?php else: ?>
    <a href="/#account-section" class="user-nav__login-button button login-button">
        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M15.7528 9.00004L12.0012 5.24847" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M12.0012 12.7516L15.7528 9" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M15.7529 9.00003H7.49951" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
