                    ...
                    <nav class="site-menu__nav--nologin">
                        <ul class="site-menu__list">
                            <li class="site-menu__item">
                                <a class="site-menu__link site-menu__nav-button active" href="/"><i class="fas fa-home"></i> <?php echo lang('menu_txt_1'); ?></a>
                            </li>
                            <li class="site-menu__item">
                                <a class="site-menu__link site-menu__nav-button" href="/register"><i class="fas fa-user-plus"></i> <?php echo lang('menu_txt_3'); ?></a>
                            </li>
                            <li class="site-menu__item">
                                <a class="site-menu__link site-menu__nav-button" href="/usercp"><i class="fas fa-user"></i> <?php echo isLoggedIn() ? lang('menu_txt_5') : lang('menu_txt_4'); ?></a>
                            </li>
                            <li class="site-menu__item">
                                <button class="site-menu__link site-menu__nav-button account-modal-trigger" 
                                        type="button" style="background: none; border: none; cursor: pointer;">
                                    <i class="fas fa-cog"></i> <?php echo lang('menu_txt_12'); ?>
                                </button>
                            </li>
                            <li class="site-menu__item">
                                <a class="site-menu__link site-menu__nav-button" href="/info"><i class="fas fa-list-ol"></i> <?php echo lang('module_titles_txt_17'); ?></a>
                            </li>
                            <li class="site-menu__item">
                                <a class="site-menu__link site-menu__nav-button" href="/downloads"><i class="fas fa-download"></i> <?php echo lang('menu_txt_7'); ?></a>
                            </li>
                            <li class="site-menu__item">
                                <a class="site-menu__link site-menu__nav-button" href="/donation"><i class="fas fa-coins"></i> <?php echo lang('menu_txt_8'); ?></a>
                            </li>
                            <li class="site-menu__item">
                                <a class="site-menu__link site-menu__nav-button" href="/rankings/"><i class="fas fa-users"></i> <?php echo lang('menu_txt_10'); ?></a>
                            </li>
                            <li class="site-menu__item">
                                <a class="site-menu__link site-menu__nav-button" href="/logout"><i class="fas fa-sign-out-alt"></i> <?php echo lang('login_txt_6'); ?></a>
                            </li>
                            
                        </ul>
                        <div class="site-menu__social">
                            <a class="site-menu__social-link site-menu__social-link--discord" href="<?php config('social_link_discord'); ?>" target="_blank">
                                <span><i class="fab fa-discord"></i> <b>Discord</b></span>
                            </a>
                            <a class="site-menu__social-link site-menu__social-link--facebook" href="<?php config('social_link_facebook'); ?>" target="_blank">
        ...
        <nav class="main-nav">
            <div class="site-nav">
                ...
                <ul class="site-nav__list">
                    <li class="site-nav__item">
                        <button class="modal__field-label selectdiv account-modal-trigger" type="button" style="background: none; border: none; cursor: pointer; padding: 0; width: 100%; text-align: left;"><span class="copyright22">Server: <b>MuPGA</b></span></button>                    </li>
            ...
            <div class="site-nav__mobile">
                ...
                <div class="site-menu__buttons site-menu__buttons--mobile">
                    ...
                    <a class="site-menu__buttons--report site-menu__button button" href="/logout"><?php echo lang('login_txt_6'); ?></a>
                </div>
...
<section class="hero" id="hero">
    <div class="wrapper">
        <div class="hero__content">
            ...
            <!-- Removed top hero headline per request -->

            <div class="hero__pegi">
                <a class="hero__reg-button" href="/register"><?php echo lang('menu_txt_3'); ?></a>
            </div>
            <!-- Removed hero text block per request -->
        </div>
    </div>
</section>
                    ...
                    <ul class="main-servers__list main-servers__list--stack">
                            ...
                            <li class="main-servers__item">
                                ...
                                <div class="main-servers__item-wrapper main-servers__link main-servers__link--active main-servers__link1">
                                    <span class="main-servers__title">MuPGA</span>
                                    ...
                                    <div class="main-servers__item-bottom">
                                        ...
                                        <div class="main-servers__info">
                                            <div class="main-servers__online">
                                                <?php echo lang('sidebar_srvinfo_txt_5'); ?>: <?php echo number_format($onlinePlayers); ?></div>
                                                <?php } ?>
                                        </div>
                                    </div>
                                </div>
